...
$generateRegistrationCode = $users->generateRegistrationCode($username);
$getRegistrationCode = $users->getRegistrationCode($username);

var_dump($generateRegistrationCode);
