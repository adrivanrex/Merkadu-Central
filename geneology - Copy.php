...
$w = $users->GetUserInfo($eDownlineLeft);
$wfirstName = $w[0]["firstName"];
$wlastName = $w[0]["lastName"];
$wUserName = $w[0]["username"];
$wDownlineLeft = $w[0]["leftDownline"];
$wDownlineRight = $w[0]["rightDownline"];
$wFullName = "".$wfirstName." ".$wlastName."";


$x = $users->GetUserInfo($eDownlineRight);
$xfirstName = $x[0]["firstName"];
$xlastName = $x[0]["lastName"];
$xUserName = $x[0]["username"];
$xDownlineLeft = $x[0]["leftDownline"];
$xDownlineRight = $x[0]["rightDownline"];
$xFullName = "".$xfirstName." ".$xlastName."";


$u = $users->GetUserInfo($jDownlineLeft);
$ufirstName = $u[0]["firstName"];
$ulastName = $u[0]["lastName"];
$uUserName = $u[0]["username"];
$uDownlineLeft = $u[0]["leftDownline"];
$uDownlineRight = $u[0]["rightDownline"];
$uFullName = "".$ufirstName." ".$ulastName."";

$v = $users->GetUserInfo($jDownlineRight);
$vfirstName = $v[0]["firstName"];
$vlastName = $v[0]["lastName"];
$vUserName = $v[0]["username"];
$vDownlineLeft = $v[0]["leftDownline"];
$vDownlineRight = $v[0]["rightDownline"];
                             ...
                             <?php elseif($c == NULL && $d) : ?>
                                ...
                                <li class="">
                                	<ul>
                                		...
                                		<?php if($dDownlineLeft == null && $dDownlineRight == null) : ?>
								            <li class="">
							                <div class="midtext-table">
							                    <div class="midtext-cell"><span class="status empty">0</span>Empty</div>
							                </div>
							            ...
							            <li class="">
							                <div class="midtext-table">
							                    <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$vUserName.""; ?>" class="status active "><span><?php echo $vUserName;?></span><?php echo "(".$vFullName.")";?></a></div>
							                </div>
							            </li>
								        <?php else : ?>
								            even more html
								        ...
								        <?php elseif ($i && $j == null) :?>
								        	<li class="">
							                <div class="midtext-table">
							                	<div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$iUserName.""; ?>" class="status active "><span><?php echo $iUserName;?></span><?php echo "(".$iFullName.")";?></a><div class="arrow-down"></div></div>
                                ...
                                <li class="">
                                    ...
                                    <?php if($cDownlineLeft == null && $cDownlineRight == NULL) : ?>
                                     ...
                                     <?php elseif($g == null && $h) : ?>
                                        ...
                                        <li class="">
                                            <div class="midtext-table">
                                                <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$hUserName.""; ?>" class="status active "><span><?php echo $hUserName;?></span><?php echo "(".$hFullName.")";?></a><div class="arrow-down"></div></div>
                                            </div>
                                        </li>
                                    ...
                                    <?php else : ?>
                                        <ul>
                                            <li class="">
                                            <div class="midtext-table">
                                                <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$gUserName.""; ?>" class="status active "><span><?php echo $gUserName;?></span><?php echo "(".$gFullName.")";?></a><div class="arrow-down"></div></div>
                                            </div>
                                        </li>
                                        <li class="">
                                            <div class="midtext-table">
                            ...
                            <?php else : ?>
                                ...
                                <li class="">
                                    ...
                                    <?php else : ?>
                                        <li class="">
                                            <div class="midtext-table">
                                                <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$gUserName.""; ?>" class="status active "><span><?php echo $gUserName;?></span><?php echo "(".$gFullName.")";?></a><div class="arrow-down"></div>
                                            </div>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <?php else : ?>
                                        <li class="">
                                            <div class="midtext-table">
                                                <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$hUserName.""; ?>" class="status active "><span><?php echo $hUserName;?></span><?php echo "(".$hFullName.")";?><div class="arrow-down"></div></a>
                                            </div>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <ul>
                                        ...
                                        <?php else : ?>
                                                ...
                                                <?php if($i && $j) : ?>
                                                    ...
                                                    <li class="">
                                                        <div class="midtext-table">
                                                            <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$jUserName.""; ?>" class="status active "><span><?php echo $jUserName;?></span><?php echo "(".$jFullName.")";?></a><div class="arrow-down"></div></div>
                                                        </div>
                                                    </li>
                    ...
                    <li class="">
                        ...
                        <?php if($bDownlineLeft == null && $bDownlineRight == NULL) : ?>
                         ...
                         <?php elseif($e == NULL && $f) : ?>
                            ...
                            <li class="">
                            	...
                            	<?php if($m == null && $n == NULL) : ?>
						         ...
						         <?php elseif($m == NULL && $n) : ?>
						            <ul>
								            ...
								            <li class="">
								                <div class="midtext-table">
								                   <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$nUserName.""; ?>" class="status active "><span><?php echo $nUserName;?></span><?php echo "(".$nFullName.")";?></a><div class="arrow-down">	</div>
								                </div>
								            </li>
								        </ul>
						        <?php else : ?>
                                ...
                                <div class="midtext-table">
                                    <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$fUserName.""; ?>" class="status active "><span><?php echo $fUserName;?></span><?php echo "(".$fFullName.")";?></a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="">
                            	<ul>
                            		<?php if($w) : ?>
                            			<li class="">
							                <div class="midtext-table">
							                	<div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$wUserName.""; ?>" class="status active "><span><?php echo $wUserName;?></span><?php echo "(".$wFullName.")";?></a><div class="arrow-down"></div>
							         ...
							         <?php elseif($w == NULL && $x) : ?>
							            ...
							            <li class="">
							                ...
							                <div class="midtext-table">
							                    <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$xUserName.""; ?>" class="status active "><span><?php echo $xUserName;?></span><?php echo "(".$xFullName.")";?></a>
							                </div>
							            </li>
							        <?php elseif($x == NULL && $w) : ?>
							        	...
							        	<li class="">
							                <div class="midtext-table">
							                	<div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$wUserName.""; ?>" class="status active "><span><?php echo $wUserName;?></span><?php echo "(".$wFullName.")";?></a>
                                ...
                                <div class="midtext-table">
                                    <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$eUserName.""; ?>" class="status active "><span><?php echo $eUserName;?></span><?php echo "(".$eFullName.")";?></a><div class="arrow-down"></div>
                        ...
                        <?php elseif($f && $e) : ?>
                            ...
                            <li class="">
                                ...
                                <div class="midtext-table">
                                    <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$eUserName.""; ?>" class="status active "><span><?php echo $eUserName;?></span><?php echo "(".$eFullName.")";?></a><div class="arrow-down"></div></div>
                                ...
                                <?php if($k == NULL && $l) : ?>
                                    <li class="">
                                     ...
                                     <li class="">
                                        <div class="midtext-table">
                                            <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$lUserName.""; ?>" class="status active "><span><?php echo $lUserName;?></span><?php echo "(".$lFullName.")";?></a><div class="arrow-down"></div></div>
                                        </div>
                                    </li>
                                 <?php elseif($leftDownline) : ?>
                                    HTML HERE
                                ...
                                <?php if($k  && $l) : ?>
                                    <li class="">
                                        <div class="midtext-table">
                                            <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$kUserName.""; ?>" class="status active "><span><?php echo $kUserName;?></span><?php echo "(".$kFullName.")";?></a><div class="arrow-down"></div></div>
                            ...
                            <li class="">
                                ...
                                <div class="midtext-table">
                                    <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$fUserName.""; ?>" class="status active "><span><?php echo $fUserName;?></span><?php echo "(".$fFullName.")";?></a><div class="arrow-down"></div></div>
                                </div>
                                    <!-- REX -->
                                ...
                                <ul>
                                    ...
                                    <li class="">
                                     ...
                                     <?php elseif($m && $n == NULL) : ?>
                                        <li class="">
                                        <div class="midtext-table">
                                            <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$mUserName.""; ?>" class="status active "><span><?php echo $mUserName;?></span><?php echo "(".$mFullName.")";?></a><div class="arrow-down"></div></div>
                                        </div>
                                    </li>
                                    <li class="">
                                        <div class="midtext-table">
                                    ...
                                    <li class="">
                                        <div class="midtext-table">
                                            <div class="midtext-cell"><a href="<?php echo "".$server."/geneology.php?username=".$nUserName.""; ?>" class="status active "><span><?php echo $nUserName;?></span><?php echo "(".$nFullName.")";?></a><div class="arrow-down"></div></div>
                                        </div>
                                    </li>
